...
urlpatterns = patterns('',
    ...
    url(r'^auth/add_admin', 'auth.views.add_admin', name='home'),
    url(r'^auth/push_add_admin', 'auth.views.push_add_admin', name='home'),
    ...
    url(r'^userinfo/payhistory', 'userinfo.views.payhistory', name='home'),    
